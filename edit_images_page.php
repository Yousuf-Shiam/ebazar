                ...
                <table class="product-images_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="delete_image.php?img=<?php echo $row['image']; ?>&prod=<?php echo $product_name; ?>">Delete</a>
                            </td>
                        </tr>
                        <?php
                            }
                        ...
                        ?>
                        <tr>
                            <form action="insert_product_images.php?prod=<?php echo $product_name;?>" method="post" enctype="multipart/form-data">
